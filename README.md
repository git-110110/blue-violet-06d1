...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/blue-violet-06d1
```

A live public deployment of this template is available at [https://blue-violet-06d1.templates.workers.dev](https://blue-violet-06d1.templates.workers.dev)
